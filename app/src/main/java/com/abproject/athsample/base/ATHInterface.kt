...
interface ATHInterface {
    ...
    fun showErrorInAuthEditTexts(
        ...
        if (email != null
            ...
            if (!email.text.checkEmailIsValid())
                email.error = viewContext?.getString(R.string.wrongEmail)
            ...
            if (!validationIranianPhoneNumber(phoneNumber.text.toString()))
                phoneNumber.error = viewContext?.getString(R.string.wrongPhoneNumber)
        } else {
            if (username.text.isEmpty())
                username.error = viewContext?.getString(R.string.usernameError)
            if (password.text.isEmpty())
